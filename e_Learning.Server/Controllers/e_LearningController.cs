...
namespace e_Learning.Server.Controllers
{
    ...
    [ApiController]
    public class E_LearningController(SignInManager<User> sm, UserManager<User> um) : ControllerBase
    {
        ...
        public async Task<ActionResult> LoginUser(Login login)
        {
            ...
            try
            {
                ...
                if(user_ != null ){ 
                    ...
                    if (!result.Succeeded)
                    {
                        return Unauthorized(new {message = "Check your credentials and try again" });
                    }
        ...
        public ActionResult AdminPage(){
            string[] partners = {"Raja", "Bill Gates", "Elon Musk",
                "Taylor Swift"};
